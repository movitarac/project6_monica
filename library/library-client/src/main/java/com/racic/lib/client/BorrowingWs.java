...
public interface BorrowingWs {
    ...
    @WebMethod
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "returnBorrowingWithSession", targetNamespace = "http://webservice.lib.racic.com/", className = "com.racic.lib.client.ReturnBorrowingWithSession")
    @ResponseWrapper(localName = "returnBorrowingWithSessionResponse", targetNamespace = "http://webservice.lib.racic.com/", className = "com.racic.lib.client.ReturnBorrowingWithSessionResponse")
    @Action(input = "http://webservice.lib.racic.com/borrowingWs/returnBorrowingWithSessionRequest", output = "http://webservice.lib.racic.com/borrowingWs/returnBorrowingWithSessionResponse")
    public boolean returnBorrowingWithSession(
            @WebParam(name = "arg0", targetNamespace = "")
                    Integer arg0,
    ...
    @WebMethod
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "borrowBookWithSession", targetNamespace = "http://webservice.lib.racic.com/", className = "com.racic.lib.client.BorrowBookWithSession")
    @ResponseWrapper(localName = "borrowBookWithSessionResponse", targetNamespace = "http://webservice.lib.racic.com/", className = "com.racic.lib.client.BorrowBookWithSessionResponse")
    @Action(input = "http://webservice.lib.racic.com/borrowingWs/borrowBookWithSessionRequest", output = "http://webservice.lib.racic.com/borrowingWs/borrowBookWithSessionResponse")
    public boolean borrowBookWithSession(
            @WebParam(name = "arg0", targetNamespace = "")
                    Integer arg0,
            @WebParam(name = "arg1", targetNamespace = "")
                    Member arg1,
    ...
    @WebMethod
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "extendBorrowingWithSession", targetNamespace = "http://webservice.lib.racic.com/", className = "com.racic.lib.client.ExtendBorrowingWithSession")
    @ResponseWrapper(localName = "extendBorrowingWithSessionResponse", targetNamespace = "http://webservice.lib.racic.com/", className = "com.racic.lib.client.ExtendBorrowingWithSessionResponse")
    @Action(input = "http://webservice.lib.racic.com/borrowingWs/extendBorrowingWithSessionRequest", output = "http://webservice.lib.racic.com/borrowingWs/extendBorrowingWithSessionResponse")
    public boolean extendBorrowingWithSession(
            @WebParam(name = "arg0", targetNamespace = "")
                    Integer arg0,
            @WebParam(name = "arg1", targetNamespace = "")
                    Member arg1,
